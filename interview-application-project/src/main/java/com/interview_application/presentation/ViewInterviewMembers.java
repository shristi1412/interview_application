...
*/
	private static Logger logger = LogManager.getLogger(ViewInterviewMembers.class.getName());
	ViewInterviewMembersService viewCandidateService = new ViewInterviewMembersServiceImpl();
	public InterviewSchedulerDTO searchById(String candidateID) throws CandidateNotFoundException {
		logger.info("Finding candidate with Candidate ID : " + candidateID);
